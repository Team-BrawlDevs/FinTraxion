...
LOGGER_NAME = "duplicate_detection_node"
...
def duplicate_detection_node(state: AgentState) -> dict:
    ...
    log.info("▶ duplicate_detection_node started")
    ...
    log.info(f"▶ duplicate_detection_node complete — {len(candidates)} candidates found")
